...
mongoose.connect(
  "mongodb+srv://kkamilxvii:8obtBlYdClXQMMM8@cluster0.zan6mlk.mongodb.net/Brainbucket"
);
...
app.post("/api/signup", async (req, res) => {
  ...
  if (userExists) return res.status(403).json({ Error: "User Already Exist" });
